...
public class Variable {
	...
	public static void main(String[] args) {
		...
		//참과 거짓을 표현하는 자료형으로 isTrue라는 이름의 변수 선언
		boolean isTrue = false; //선언과 동시에 false라는 값을 대입
		isTrue = true;
		System.out.println(isTrue);
		
		//실수형(소수점6자리까지 사용) 자료형으로 num2 라는 이름의 변수를 선언
		float num2;
		num2 = 3.141512585f;
		 ...
		 * 문자열
		 * String
		 * 문자열 같은 경우 할당할 메모리크기가 가변적이므로 원시타입이 아닌 객체타입으로 변수를 만들어 사용
		 * 
		 * 원래 객체를 만드는 방식ㅇ
		...
		String str2 = "누구?";
		str2 = null; //String의 변수는 참조변수이기 때문에 기본값이 null이고 빈값을 표현하기 위해 null을 대입할 수 잇다.
		
		/*
		 * 이스케이프 시퀀스
		 * 문자열내에서 탭, 백슬러시, 작따옴표등을 사용하기 위한 방식
		 * 
		 * */
		...
		// \ : 백슬래시(\) 
		// 문자 자체로 출력
		System.out.println("경로 : C:\\workspace\\02_JAVA\\01_Basic ");
		 ...
		 * 
		 * 대문자스네이크케이스 : 스네이크케이스 + 모두 대문자(자바의 상수명)
		 * ex)USER_NAME
		 * 
