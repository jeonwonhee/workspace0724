...
--JOIN절에 같이 조인하고자 하는 테이블을 기술 + 매칭시킬 컬럼에 대한 조건도 기술
--[INNER]JOING [USING/ON]
...
SELECT DEPT_ID, DEPT_TITLE, LOCAL_NAME, LOCAL_CODE
FROM DEPARTMENT
...
/*
    ...
    단, 반드시 LEFT/RIGHT를 지정해야한다. (어떤 테이블을 기준으로 할 것인가)
    
*/

--외부조인과 비교할만한 내부조인
--사원명, 부서명, 급여, 연봉
--부서배치를 받지 않은 2명의 사원정도는 어떻게 되는가?
...
/*
    ...
    ON이나 USING조건을 지정하지 않아도 두 테이블 간의 공통된 컬럼을 기반으로 조인
