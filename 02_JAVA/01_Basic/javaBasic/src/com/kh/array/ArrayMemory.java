...
public class ArrayMemory {
	...
	public static void main(String[] args) {
		...
		//객체 메모리 주소의 암호화된 해시값을 hashCode()로 가져올 수 없다.
		...
		//. :접근연산자
		//iArr.hashCode();
		//NillPointerException -> 참조변수가 가지고있는 주소값이 없다.
		...
		//배열의 가장 큰 단점
		//배열은 한 번 지정하면 크기변경이 불가
		
		arr = new int[10]; //새로운 배열읆 만들어서 위의 arr과 해시값이 다르당.
		
		/*
		 * 연결이 끊어진 기존 배결의 메모지공간은 Heap영역에 남아있다.(어떤 변수에도 참조되지 않는 상태)
