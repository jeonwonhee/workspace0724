...
-NVL없이는 BONUS IS NOT NULL을 사용하면 된다.
...
SELECT EMP_ID, EMP_NAME, 
      FLOOR((SYSDATE -  TO_DATE(SUBSTR(EMP_NO,1,6),'RRMMDD'))-365) AS 나이, DEPT_TITLE, JOB_NAME
FROM EMPLOYEE
...
--나이 구하는 식
SELECT FLOOR((SYSDATE -  TO_DATE(SUBSTR(EMP_NO,1,6),'RRMMDD'))-365)
FROM EMPLOYEE;
