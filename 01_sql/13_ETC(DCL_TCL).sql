/*
    <DCL : 데이터 제어문>
    계쩡에 시스템권한 또는 객체접근 권한을 부여하거나 회수하는 구문
...
/*
    <TCL : 트랜잭션 제어문>
    트랜잭션은 하나이상의 DML(INSERT, UPDAQQTE, DELETE)문을 묶어서 하나의 논리적 작업 단위로 처리하는 개념
...
/*
   ...
   I(Isolation) 독립성 : 여러 트랜잭션이 동시에 실행되도 서로 간섭없이 독립적으로 실행되어야 한다.
