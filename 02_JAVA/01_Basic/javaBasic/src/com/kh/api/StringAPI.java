...
public class StringAPI {
	public void method01() {
		...
		//그래서 참조변수 출력시 Object의 toString형식(타입@주소값16진수)이 아니라
		//String의 저장된 문자열이 반환됨.
		
		System.err.println(str1 == str2);
		//String객체의 주소값을 비교하기 때문에 false가 나옴
		
		System.out.println(str1.equals(str2));
		//String 클래스에서 equals메서드도 이미 오버라이딩 되어있음(주소값 비교가 아니라 문자열 값을 비교)
		
		System.out.println(str1.hashCode());
		System.out.println(str2.hashCode());
		//String 클래스에서 hashCode메서드도 이미 오버라이딩  되어있음(주소값이 아닌 문자열을 가지고 해시값을 만듦
		...
		str3 = "bye";
		System.out.println(System.identityHashCode(str3));
		//String 리터럴의 특성상 참조변수의 값을 변경하는 순간 기존 문자열 메모리에 값을
		//변경하는게 아니라 상수이기 때문에 새로운 값을 String pool에 만들고 참조하도록 되어있음.
	...
	public void method03() {
		...
		System.out.println(stn.nextToken());
		System.out.println(stn.nextToken());
		//System.out.println(stn.nextToken()); 더이상 토큰이 남아있지 않을 때 다음 토큰 호출 시 예외발생
		...
		stn = new StringTokenizer(str,",");
		while(stn.hasMoreElements()) { //남은 토큰이 잇나?
